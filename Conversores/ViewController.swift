...
//  Conversores
//
//  Created by GVP on 21/12/17.
//  Copyright © 2017 Phelipe Lopes. All rights reserved.
//
...
class ViewController: UIViewController {
    ...
    @IBOutlet weak var btUni2: UIButton!
    ...
    @IBAction func showNext(_ sender: UIButton) {
        ...
        case "Temperatura":
            ...
            btUni2.setTitle("Libra", for: .normal)
        case "Peso":
            lbUnit.text = "Moeda"
            btUnit1.setTitle("Real", for: .normal)
            btUni2.setTitle("Dólar", for: .normal)
        case "Moeda":
            lbUnit.text = "Distância"
            btUnit1.setTitle("Metro", for: .normal)
            btUni2.setTitle("Kilômetro", for: .normal)
        default:
            lbUnit.text = "Temperatura"
            btUnit1.setTitle("Celsius", for: .normal)
            btUni2.setTitle("Farenheint", for: .normal)
        }
        convert(nil)
    }
